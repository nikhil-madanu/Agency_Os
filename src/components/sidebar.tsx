  ...
  return (
    <aside className={cn(
      ...
      <div className="flex flex-col flex-1 min-h-max relative">
        ...
        {/* Logo Section */}
        <div className={cn("flex items-center mb-2 xl:mb-5 transition-all", isCollapsed ? "justify-center mt-4 xl:mt-6 px-0" : "gap-3 px-1 xl:px-2")}>
        ...
        <div className={cn("group relative flex items-center hover:bg-slate-50 transition-colors cursor-pointer border border-transparent hover:border-slate-100", isCollapsed ? "justify-center p-2 mb-2 xl:mb-4 rounded-xl" : "gap-3 px-2 mb-2 xl:mb-5 p-1.5 xl:p-2 rounded-2xl")}>
          <img 
          ...
          {mainNavItems.map((item) => (
            <a
              ...
              className={cn(
                ...
                isCollapsed ? "justify-center p-2.5 xl:p-3 rounded-xl" : "gap-3 px-3 xl:px-4 py-1.5 xl:py-3 rounded-2xl",
      ...
      {/* Bottom Navigation */}
      <div className="border-t border-slate-100/80 pt-2 xl:pt-4 mt-auto flex flex-col gap-0 xl:gap-2 relative z-50">
        <a href="#" className={cn("group relative flex items-center font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-900 border border-transparent transition-all duration-300", isCollapsed ? "justify-center p-2.5 xl:p-3 rounded-xl relative" : "justify-between px-3 xl:px-4 py-1.5 xl:py-3 rounded-2xl text-[13.5px] xl:text-[14.5px]")}>
        ...
        <a href="#" className={cn("group relative flex items-center font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-900 border border-transparent transition-all duration-300", isCollapsed ? "justify-center p-2.5 xl:p-3 rounded-xl" : "gap-3 px-3 xl:px-4 py-1.5 xl:py-3 rounded-2xl text-[13.5px] xl:text-[14.5px]")}>
        ...
        <button className={cn("group relative flex items-center font-medium text-slate-500 hover:bg-red-50 hover:text-red-700 border border-transparent transition-all duration-300 text-left w-full", isCollapsed ? "justify-center p-2.5 xl:p-3 rounded-xl" : "gap-3 px-3 xl:px-4 py-1.5 xl:py-3 rounded-2xl text-[13.5px] xl:text-[14.5px]")}>
